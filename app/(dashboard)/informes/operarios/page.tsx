...
export default function OperatorsReport() {
  ...
  const stats = useMemo(() => {
    ...
    return { active: active.length, inactive: operators.length - active.length, totalRevenue, totalCompleted, totalActive, avgNps, bySpecialty, revenueRanking, completedRanking, npsRanking, allActive: active };
  }, [operators]);
